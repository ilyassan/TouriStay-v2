<x-app-layout>
    <x-slot:title> Log in to TouriStay </x-slot>
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}" class="font-medium text-[#FF5A5F] hover:text-[#E94E53]">
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    Don't have an account?
                    <a href="{{ route('register') }}" class="font-medium text-[#FF5A5F] hover:text-[#E94E53]">
                        Sign up
                    </a>
                </p>
            </div>
